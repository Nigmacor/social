...
from management.views import Statistic, Shop_info, Shop_stat, Prod_info, Prod_stat, Prod_stat_daily, Comments_info
...
urlpatterns = [
    ...
    path('prod_stat/daily/<str:id>/', Prod_stat_daily.as_view(), name='prod_stat_daily_url'),
